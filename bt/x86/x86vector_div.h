...
// *
// *  @brief generator 3, assembler vector double/float div, MS Visual C++ 2003-2008
// *
...
//**************************** DIV STDCALL *********************************
// div vectors eax=[esp+4]-a void *, edx=[esp+8]-b void *, ecx=[esp+12]-rez void *

/// Поэлементное деление двухмерных векторов одинарной точности, команды FPU.
#define VECTORP2DDIVFPU_STD \
_BEGIN_ASM \
...
/// Поэлементное деление трехмерных векторов одинарной точности, команды SSE.
#define VECTORP2DDIVSSE_STD \
_BEGIN_ASM \
_LINE4( 0x8B,0x44,0x24,0x04 )                               /* mov         eax,dword ptr [esp+4]  */ \
ASM( xorps xmm0,xmm0 ) \
_LINE4( 0x8B,0x54,0x24,0x08 )                               /* mov         edx,dword ptr [esp+8]  */ \
...
/// Поэлементное деление трехмерных векторов одинарной точности, команды FPU.
#define VECTORP3DDIVFPU_STD \
_BEGIN_ASM \
_LINE4( 0x8B,0x44,0x24,0x04 )                               /* mov         eax,dword ptr [esp+4]  */ \
_STR(_DB(0xD9) _DB(0x00)) \
_LINE4( 0x8B,0x54,0x24,0x08 )                               /* mov         edx,dword ptr [esp+8]  */ \
...
/// Поэлементное деление четырехмерных векторов одинарной точности, команды FPU.
#define VECTORP4DDIVFPU_STD \
_BEGIN_ASM \
_LINE4( 0x8B,0x44,0x24,0x04 )                               /* mov         eax,dword ptr [esp+4]  */ \
_STR(_DB(0xD9) _DB(0x00)) \
_LINE4( 0x8B,0x54,0x24,0x08 )                               /* mov         edx,dword ptr [esp+8]  */ \
...
/// Поэлементное деление четырехмерных векторов одинарной точности, команды SSE.
#define VECTORP4DDIVSSE_STD \
_BEGIN_ASM \
_LINE4( 0x8B,0x44,0x24,0x04 )                               /* mov         eax,dword ptr [esp+4]  */ \
...
/// Поэлементное деление двухмерных векторов двойной точности, команды FPU.
#define VECTORP2DDDIVFPU_STD \
_BEGIN_ASM \
_LINE4( 0x8B,0x44,0x24,0x04 )                               /* mov         eax,dword ptr [esp+4]  */ \
...
/// Поэлементное деление двухмерных векторов двойной точности, команды SSE2.
#define VECTORP2DDDIVSSE2_STD \
_BEGIN_ASM \
_LINE4( 0x8B,0x44,0x24,0x04 )                               /* mov         eax,dword ptr [esp+4]  */ \
...
/// Поэлементное деление трехмерных векторов двойной точности, команды FPU.
#define VECTORP3DDDIVFPU_STD \
_BEGIN_ASM \
_LINE4( 0x8B,0x44,0x24,0x04 )                               /* mov         eax,dword ptr [esp+4]  */ \
_STR(_DB(0xDD) _DB(0x00)) \
_LINE4( 0x8B,0x54,0x24,0x08 )                               /* mov         edx,dword ptr [esp+8]  */ \
...
/// Поэлементное деление трехмерных векторов двойной точности, команды SSE2.
#define VECTORP3DDDIVSSE2_STD \
_BEGIN_ASM \
_LINE4( 0x8B,0x44,0x24,0x04 )                               /* mov         eax,dword ptr [esp+4]  */ \
...
/// Поэлементное деление трехмерных векторов двойной точности, команды SSE3.
#define VECTORP3DDDIVSSE3_STD \
_BEGIN_ASM \
_LINE4( 0x8B,0x44,0x24,0x04 )                               /* mov         eax,dword ptr [esp+4]  */ \
...
/// Поэлементное деление четырехмерных векторов двойной точности, команды FPU.
#define VECTORP4DDDIVFPU_STD \
_BEGIN_ASM \
_LINE4( 0x8B,0x44,0x24,0x04 )                               /* mov         eax,dword ptr [esp+4]  */ \
_STR(_DB(0xDD) _DB(0x00)) \
_LINE4( 0x8B,0x54,0x24,0x08 )                               /* mov         edx,dword ptr [esp+8]  */ \
...
/// Поэлементное деление четырехмерных векторов двойной точности, команды SSE2.
#define VECTORP4DDDIVSSE2_STD \
_BEGIN_ASM \
_LINE4( 0x8B,0x44,0x24,0x04 )                               /* mov         eax,dword ptr [esp+4]  */ \
_LINE5( 0xF2,0x0F,0x10,0x48,0x08 )                          /* movsd       xmm1,mmword ptr [eax+8]  */ \
_LINE4( 0x8B,0x54,0x24,0x08 )                               /* mov         edx,dword ptr [esp+8]  */ \
...
/// Поэлементное деление четырехмерных векторов двойной точности, команды AVX
#define VECTORP4DDDIVAVX_STD \
_BEGIN_ASM \
_LINE4( 0x8B,0x44,0x24,0x04 )         /* mov         eax,dword ptr [esp+4]  */ \
...
_LINE4( 0xC5,0xFD,0x5E,0xD9 )         /* vdivpd      ymm3,ymm0,ymm1  */ \
_LINE4( 0xC5,0xFD,0x11,0x18 )         /* vmovupd     ymmword ptr [eax],ymm3  */ \
_LINE3( 0xC5,0xF8,0x77 )              /* vzeroupper  */ \
_END_ASM

//**************************** DIV REGISTER FASTCALL *********************************
// div vectors eax-a void *, edx-b void *, ecx-rez void *

/// Поэлементное деление двухмерных векторов одинарной точности, команды FPU.
#define VECTORP2DDIVFPU \
_BEGIN_ASM \
_STR(_DB(0xD9) _DB(0x00)) \
_STR(_DB(0xD8) _DB(0x0A)) \
_STR(_DB(0xD9) _DB(0x19)) \
