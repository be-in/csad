...
namespace csad {
	...
	{
#if _NTO_VERSION < 660
		return ((LocalDisplay*)p_parent)->p_display.disp_info.xres;
#else
		return ((LocalDisplay*)p_parent)->p_display.width;
#endif
	}
	...
	{
#if _NTO_VERSION < 660
		return ((LocalDisplay*)p_parent)->p_display.disp_info.yres;
#else
		return ((LocalDisplay*)p_parent)->p_display.height;
#endif
	}
	...
	bool GlContext::makeCurrent()
	{
		...
		{
			Log::console("Make current failed: 0x%x", eglGetError());
			return false;
		}
		p_current = this;
		return true;
